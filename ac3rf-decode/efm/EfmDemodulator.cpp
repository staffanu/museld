...
EfmDemodulator::EfmDemodulator(Logger &log, double input_sample_frequency, int input_block_size, int output_fd,
    ...
    if (m_rf_input) {
        ...
        m_input_filter = { // 2 MHz lowpass filter at 24.583 MHz
            0.001636, 0.001729, 0.001501, 0.000281, -0.002621, -0.007281, -0.012615, -0.016214, -0.014783, -0.005131, 0.014569, 0.043717, 0.078869, 0.114229, 0.142987, 0.159126, 0.159126, 0.142987, 0.114229, 0.078869, 0.043717, 0.014569, -0.005131, -0.014783, -0.016214, -0.012615, -0.007281, -0.002621, 0.000281, 0.001501, 0.001729, 0.001636        };
        //m_input_filter = { 1 };
    }
